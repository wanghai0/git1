...
<script type="text/javascript">
    ...
    function queryOfficerWish() {
        ...
        $.ajax({
            type : "POST",
            url  : "${pageContext.request.contextPath}/queryOfficerWish",
            data : "stuNum=" + $("#stuNum").val(),
            dataType : "json",
            success : function(data) {
                var zykHsListMap=data.zykHsListMap;
                $("#res_div").empty();
                ...
                $.each(zykHsListMap,function(i,n){
                    switch(i){
                        case "wishList_z":
                            $("#resTab").append("<tr><td colspan='5'>直招士官</td></tr>");
        ...
        <div class="form-group">
            <form class="form-horizontal">
                ...
                <button type="button" class="button-default"
                    onclick="queryOfficerWish()">直招士官志愿查询</button>
            </form>
        </div>
